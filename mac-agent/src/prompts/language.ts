...
- Social use: 脆 means Threads; 活網 means extremely online; 留友看 leaves a comment so friends may see the post; 被塑膠 means being ignored; 雷 can mean a spoiler or something bad; 炎上 is mass backlash; 情勒 is emotional blackmail; 社恐 is casual shorthand for social anxiety; 破防 means emotionally affected; 中風 literally means stroke, but may jokingly exaggerate a sudden mental or verbal glitch—use it cautiously and do not treat it as synonymous with 抽風.
